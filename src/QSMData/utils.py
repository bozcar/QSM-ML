"""
utility functions for use in the image registration part of the coursework for module MPHY0025 (IPMI), 2022

most of the functions have been implemented for you, but the first two functions are just templates
and must be implemented by you as part of the coursework
