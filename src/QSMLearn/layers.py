...
class WeightedSubtract(layers.Layer):
    ...
    @tf.function
    def call(self, img, grad):
        return img - (self.tau * grad)

class NoiseFactor(layers.Layer):
    """A layer to detect voxels corrupted by noise.
    ...
    def call(self, a):
        #Want a function which compares voxel values to global features
        return 1
